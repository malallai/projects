...
class GeneralSql extends Sql {
    ...
    public function getPosts($page = 1) {
        try {
            ...
            $request = self::bindValueRunList("SELECT * FROM posts ORDER BY date LIMIT :offset, :fetch",  array("offset" => array($start, PDO::PARAM_INT), "fetch" => array($postsPerPage, PDO::PARAM_INT)), PDO::FETCH_ASSOC);
